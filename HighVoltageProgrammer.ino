...
//
// 1 - Compile and upload this code on a Arduino UNO (or similar)   
// 2 - Assemble the circuit, according to the "schematic.png" diagram
// 3 - Double check connections, and power on 12V
// 4 - Open Serial Monitor (Or Putty) - Set 19200 baud - No Line Ending
// 5 - On Message: "Enter any character to start process.." - Begin Process 
//
/////////////////////////////////////////////////////////////////////////////
...
void chip_erase() {
  ...
  while (!digitalRead(SDO))
    ;  //wait until chip erase completes (wait until SDO goes high)
}
